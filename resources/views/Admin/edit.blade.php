...
<body>
    ...
    <div class="container mx-auto py-8">
        ...
        <form action="{{ route('admin.edit-property.store', $property->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 grid grid-cols-2 gap-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="user_id" value="{{ $property->user_id }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div>
            ...
            <div class="col-span-2">
                ...
                <div class="flex space-x-4">
                    <input type="file" name="image_1" class="block w-full text-sm text-gray-500 border-gray-300 rounded-md shadow">
                    <input type="file" name="image_2" class="block w-full text-sm text-gray-500 border-gray-300 rounded-md shadow">
                </div>
            </div>
